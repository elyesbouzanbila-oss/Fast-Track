...
form.addEventListener('submit', function(e) {
    ...
    const select4 = document.getElementById('advancedSelect4');
...
['advancedSelect', 'advancedSelect2', 'advancedSelect3', 'advancedSelect4'].forEach((id, index) => {
  ...
  resources: {
    fr: {
      translation: {
          ...
          "error.select4": "Veuillez choisir un état de la route",
    ...
    en: {
      translation: {
          ...
          "error.select4": "Please select a route status",
    ...
    ar: {
      translation: {
          ...
          "error.select4": "يرجى اختيار حالة الطريق",
